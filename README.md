...
Install tensorflow for CPU `pip install tensorflow==1.14.0` or for CUDA-enabled GPU `pip install tensorflow-gpu==1.14.0`. Hence, this code was developed following the Tensorflow 1 API, not Tensorflow 2.
