...
Install tensorflow for CPU `pip install tensorflow==1.14.0` or for CUDA-enabled GPU `pip install tensorflow-gpu==1.14.0`. Hence, this code does not work for tensorflow 2.
